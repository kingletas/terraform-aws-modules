...
```hcl
module "github" {
  source = "github.com/kingletas/terraform-aws-modules//modules/iam-oidc-provider?ref=v0.7.0"
...
module "deploy_role" {
  source = "github.com/kingletas/terraform-aws-modules//modules/iam-role?ref=v0.7.0"
