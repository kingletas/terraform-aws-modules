...
module "under_test" {
  ...
  name             = "plan-test"
  requester_vpc_id = aws_vpc.this.id
  accepter_vpc_id  = aws_vpc.other.id

  requester_route_table_ids  = { a = aws_route_table.this.id }
  requester_destination_cidr = "10.1.0.0/16"

  accepter_route_table_ids  = { a = aws_route_table.other.id }
